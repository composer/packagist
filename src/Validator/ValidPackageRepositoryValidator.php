...
class ValidPackageRepositoryValidator extends ConstraintValidator
{
    ...
    public function validate(mixed $value, Constraint $constraint): void
    {
        ...
        $reservedVendors = ['php', 'packagist', 'api', 'sdk', 'auth', 'openai', 'annotation', 'authentication', 'authorization', 'dependency', 'dependencies', 'kernel', 'namespace', 'namespaces', 'rfc', 'routing', 'standards', 'standard', 'token', ...NotReservedWord::RESERVED_WORDS];
