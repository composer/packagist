...
/**
 * The invitee explicitly declines a pending invitation.
 */
final readonly class UserInvitationDeclined implements InvitationEvent
{
    public const OrganizationEventType TYPE = OrganizationEventType::UserInvitationDeclined;
