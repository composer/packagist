...
/**
 * An owner cancels a pending invitation before it is accepted.
 */
final readonly class UserInvitationRevoked implements InvitationEvent
{
    public const OrganizationEventType TYPE = OrganizationEventType::UserInvitationRevoked;
