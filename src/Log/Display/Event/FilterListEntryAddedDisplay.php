...
readonly class FilterListEntryAddedDisplay extends AbstractLogDisplay
{
    ...
    {
        return AuditLogEventType::FilterListEntryAdded;
    }

    public function getTemplateName(): string
    {
        return 'log/display/filter_list_entry_added.html.twig';
    }
}
