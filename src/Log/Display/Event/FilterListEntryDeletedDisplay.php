...
readonly class FilterListEntryDeletedDisplay extends AbstractLogDisplay
{
    ...
    {
        return AuditLogEventType::FilterListEntryDeleted;
    }

    public function getTemplateName(): string
    {
        return 'log/display/filter_list_entry_deleted.html.twig';
    }
}
