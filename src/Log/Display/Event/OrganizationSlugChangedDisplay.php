...
readonly class OrganizationSlugChangedDisplay extends AbstractLogDisplay
{
    ...
    {
        return AuditLogEventType::OrganizationSlugChanged;
    }

    public function getTemplateName(): string
    {
        return 'log/display/organization_slug_changed.html.twig';
    }
}
