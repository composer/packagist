...
readonly class OrganizationTeamMemberAddedDisplay extends AbstractLogDisplay
{
    ...
    {
        return AuditLogEventType::OrganizationTeamMemberAdded;
    }

    public function getTemplateName(): string
    {
        return 'log/display/organization_team_member_added.html.twig';
    }
}
