...
readonly class OrganizationTeamMemberRemovedDisplay extends AbstractLogDisplay
{
    ...
    {
        return AuditLogEventType::OrganizationTeamMemberRemoved;
    }

    public function getTemplateName(): string
    {
        return 'log/display/organization_team_member_removed.html.twig';
    }
}
