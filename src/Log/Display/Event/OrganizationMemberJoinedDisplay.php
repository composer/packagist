...
readonly class OrganizationMemberJoinedDisplay extends AbstractLogDisplay
{
    ...
    {
        return AuditLogEventType::OrganizationMemberJoined;
    }

    public function getTemplateName(): string
    {
        return 'log/display/organization_member_joined.html.twig';
    }
}
