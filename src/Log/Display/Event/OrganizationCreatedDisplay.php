...
readonly class OrganizationCreatedDisplay extends AbstractLogDisplay
{
    ...
    {
        return AuditLogEventType::OrganizationCreated;
    }

    public function getTemplateName(): string
    {
        return 'log/display/organization_created.html.twig';
    }
}
