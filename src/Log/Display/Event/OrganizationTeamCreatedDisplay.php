...
readonly class OrganizationTeamCreatedDisplay extends AbstractLogDisplay
{
    ...
    {
        return AuditLogEventType::OrganizationTeamCreated;
    }

    public function getTemplateName(): string
    {
        return 'log/display/organization_team_created.html.twig';
    }
}
