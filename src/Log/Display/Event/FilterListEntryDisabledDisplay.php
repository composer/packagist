...
readonly class FilterListEntryDisabledDisplay extends AbstractLogDisplay
{
    ...
    {
        return AuditLogEventType::FilterListEntryDisabled;
    }

    public function getTemplateName(): string
    {
        return 'log/display/filter_list_entry_disabled.html.twig';
    }
}
