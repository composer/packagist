...
readonly class PackageDeletedDisplay extends AbstractTransparencyDisplay
{
    ...
    {
        return TransparencyLogType::PackageDeleted;
    }

    public function getTemplateName(): string
    {
        return 'transparency_log/display/package_deleted.html.twig';
    }
}
